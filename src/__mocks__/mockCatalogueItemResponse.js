export const mockCatalogueItemResponse = {
    'id': 134,
    'name': 'Патье-рыбка 4',
    'description': 'Платье-рыбка 2',
    'mainImageUrl': 'http://drive.google.com/uc?export=view&id=1GzPcAb4BzO3BhUD8ATRTltmTRwKDOqz14',
    'category': {
        'id': 54,
        'name': 'Свадебные',
