...
import ProductSettingCard from './pages/ProductSettings/components/ProductSettingCard/ProductSettingCard';
        ...
        <div className={s.adminRoutes}>
            ...
            <div className={s.adminPage}>
                <Routes>
                    ...
                    <Route path="products-card" element={<ProductSettingCard/>}/>
                    <Route
